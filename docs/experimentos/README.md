...
| -------------------------------------------------------- | ------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [001](001-cobertura-depende-da-estrutura-declarada.md)   | A cobertura da auditoria depende do recipiente do documento? | Depende da **estrutura declarada**, não do recipiente — e o relatório não dizia. Corrigido no ADR-084                                                                                                                      |
| [002](002-o-que-o-corpus-assistido-consegue-publicar.md) | O que o corpus assistido consegue publicar sobre texto real? | **1 de 3** critérios passa no portão, e o que ele publica é uma **ausência** (0 falso positivo em 16 trechos), não uma taxa. Os outros dois têm concordância entre rotuladores abaixo do piso, e **revisão não move isso** |
