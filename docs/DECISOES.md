...
**Próximo passo natural (não feito):** gerar a tabela `-er`/`-ir` + irregulares a partir do VERB.tsv
do PortiLexicon-UD (com desambiguação de `-ido` e teste amostral contra o léxico), zerando também a
manutenção dessa fatia.
