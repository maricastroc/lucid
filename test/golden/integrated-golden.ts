...
export const GOLDEN_INTEGRADO: readonly GoldenCase[] = [
  ...
  },
  {
    ...
    expected: {
      findings: [
        ...
        {
          criterion: "nominalizacao_encadeada",
          severity: "info",
          start: 28,
          end: 37,
          spanText: "avaliação",
        ...
        },
        {
          ...
          spanText: "entrega dos documentos",
          requiresHuman: true,
        },
      ],
      ...
      findings: [
        {
          ...
          spanText: "foi assinado pelo diretor.",
          requiresHuman: false,
        },
        {
          criterion: "passive_voice",
    ...
    expected: {
      findings: [
        ...
        },
        {
          ...
          spanText: "análise de documentos",
          requiresHuman: true,
        },
      ],
      metrics: { words: 14, sentences: 2 },
    ...
    expected: {
      findings: [
        ...
        },
        {
          ...
          spanText: "foi analisado pela comissão",
          requiresHuman: false,
        },
        {
          criterion: "nominalization",
        ...
        },
        {
          ...
          spanText: "verificação dos documentos",
          requiresHuman: true,
        },
        {
          criterion: "jargon",
          ...
          spanText: "supracitados",
          requiresHuman: false,
          suggestion: "citados acima",
        },
        {
          criterion: "jargon",
          severity: "warning",
  ...
  },
  {
    ...
    expected: {
      findings: [
        ...
        },
        {
          ...
          spanText: "supramencionado",
          requiresHuman: false,
          suggestion: "mencionado acima",
        },
        {
          criterion: "passive_voice",
          severity: "warning",
    ...
    notes:
      "'Doravante'/'Outrossim' capitalizados NÃO são suprimidos: são a primeira palavra da frase (a guarda de nome próprio só age em meio de frase).",
  },
  {
  ...
  },
  {
    ...
    notes:
      "'sem prejuízo de' está entre aspas curvas “ ” → suprimido pela guarda de aspas. Offsets preservados apesar de travessão e §.",
  },
  {
    ...
    notes:
      "'a análise que se fez' não é nominalização verbo-leve (não há verbo leve + determinante + nominalização adjacentes), mas É passiva sintética proclítica: 'que' força a próclise e o 'se' esconde quem fez a análise.",
  },
  {
  ...
  },
  {
    ...
    notes:
      "😀 (U+1F600) ocupa 2 code units UTF-16; o span de 'supracitado' reflete esse deslocamento e ainda reconstrói via slice.",
  },
  {
    id: "texto_vazio",
