...
export const CRITERION_TAXONOMY: Record<CriterionId, CriterionTaxonomyEntry> = {
  ...
  mais_que_perfeito_sintetico: { source: "editorial", principleGroup: "understandable" },
  gerundismo: { source: "editorial", principleGroup: "understandable" },
  mesoclise: { source: "editorial", principleGroup: "understandable" },
  adverbio_mente_denso: { source: "editorial", principleGroup: "understandable" },
  adverbios_vagos: { source: "editorial", principleGroup: "understandable" },
